"""add my cool new core_zenodo_logs table

Revision ID: 1097f31cdffb
Revises: b4fee22b4a4d
Create Date: 2025-06-16 15:45:30.274935
...
def upgrade() -> None:
    ...
    sa.Column('software_hash_id', sa.String(), nullable=True, comment='A Software Heritage Software Hash ID (SWHID).'),
